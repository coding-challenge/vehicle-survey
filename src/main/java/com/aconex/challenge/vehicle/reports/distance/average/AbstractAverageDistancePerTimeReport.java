 ...
 * @author bmaturi
 */
public abstract class AbstractAverageDistancePerTimeReport extends AbstractVehicleReport {
    ...
    private void printReport(long timeInterval, VehicleRecordDataAccess vehicleDataAccess) {
        for (final Direction direction : getDirections()) {
            ...
            final Map<Long, String> averageResult = vehicleDataAccess.fetchAverageDistancesBetweenvehicles(
